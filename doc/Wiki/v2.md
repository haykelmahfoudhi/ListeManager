...
#### Menu
  ...
  * [Construct & execute](#constructExecute)
  * Autres classes
...
// Désactiver le lien sans passer apr le constructeur
$lm->setHelpLink(null);
?>
```
...
Dans l'exemple suivant nous sélectionnons les colonnes id, a1 et a2 de la table A et colB de la table B, et nous allons tous les changer. On suppose que les colonnes de A trouvent des homologues en B, d'ou la necessité de préciser le nom de la table dans la clause SELECT, mais ce n'est aps le cas de colB.
...
# <a name='constructExecute'></a> Construct & execute
